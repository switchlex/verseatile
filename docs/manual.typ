...
The distance between the verse numbers and the leftmost border of the #arg("poembody") is configureable via updating a state variable: 
...
Initial release.    Specification for the indentation of verses --- If no line in the poem is to be specially indented this should be 0. For advanced use of indentpatterns see @using-indentpatterns.
  ]
]
